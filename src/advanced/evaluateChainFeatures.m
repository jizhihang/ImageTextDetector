function [chainFeat, chainFeatureVector] = evaluateChainFeaturesp(image,... 
                                                    components,...
                                                    chains, compFeat,...
                                                    compProbabilities)
    ...
    for idx=1:1:numel(chains)
        ...
        featureVector = [chainFeatStruct.nComp, ...
                         chainFeatStruct.avgProbability,...
                         avgColorSimilarity,...
                         avgStructureSimilarity,...
                         chainFeatStruct.avgTurningAngle,...
                         chainFeatStruct.distVariation,...
                         chainFeatStruct.sizeVariation,...
                         chainFeatStruct.directionBias,...
                         chainFeatStruct.avgAxialRatio,...
                         chainFeatStruct.avgDensity,...
                         chainFeatStruct.avgWidthVariation];
        chainFeatureVector = [chainFeatureVector; featureVector];
    end
end
